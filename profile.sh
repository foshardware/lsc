...
stack build --pedantic --profile --ghc-options=-fprof-auto && stack exec -- lsc -l sample/osu035.lef -b sample/fulladder.blif -c svg -d -j 4 --smt yices +RTS -p > result1.svg
